...
export function getFrontendDashboardRoutes(): RouteObject[] {
	const frontendDashboardRoutes: RouteObject[] = [
		{ path: "/dashboards/super_admin", element: Component("/pages/dashboards/super_admin/super_admin") },
		{ path: "/dashboards/admin", element: Component("/pages/dashboards/admin/admin") },
		{ path: "/dashboards/teacher", element: Component("/pages/dashboards/teacher/teacher") },
		{ path: "/dashboards/parent", element: Component("/pages/dashboards/parent/parent") },
		{ path: "/dashboards/student", element: Component("/pages/dashboards/student/student") },
		{ path: "/analysis", element: Component("/pages/analysis/analysis") },
		{
			path: "components",
			children: [
